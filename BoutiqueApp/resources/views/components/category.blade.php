...
<section class="mb-16">
    ...
    <div class="flex flex-wrap justify-center gap-4">
        ...
        <a href="#" class="inline-block text-indigo-800 font-semibold px-6 py-3 rounded-full hover:bg-indigo-200 transition-colors duration-200 shadow-sm hover:shadow-md">
            {{$category['name']}}
        </a>
        @empty
