@props(['item'])
   ...
   <div class="cart-item flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-lg shadow-sm" data-id="1" data-price="25.99">
    ...
    <div class="flex-grow text-center sm:text-left">
        ...
        <p class="text-xl font-bold text-gray-900 mt-1">€<span class="item-price"></span></p>
    </div>
    ...
    <a href="{{route('cart.remove',$item->id)}}" class="remove-item-btn bg-red-500 text-white hover:bg-red-600 rounded-md px-4 py-2 mt-4 sm:mt-0 sm:ml-6 transition-colors duration-200">
        Supprimer
    </a>
</div>
