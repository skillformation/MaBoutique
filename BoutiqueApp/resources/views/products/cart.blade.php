...
{{-- Ajout d'une animation de suppression pour les articles du panier --}}
{{-- Ajout de boutons pour augmenter/diminuer la quantité des articles --}}
{{-- Mise à jour dynamique du sous-total, des frais de livraison et du total du panier --}}
{{-- Ajout d'un bouton pour ajouter un nouvel article aléatoire au panier --}}
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
