...
<body class="bg-gray-100 p-4 sm:p-6 lg:p-8">
    <div class="container mx-auto max-w-4xl bg-white rounded-xl shadow-lg p-6 md:p-8">
        ...
        <div id="cart-items-container" class="space-y-6 mb-8">
            ...
            <div class="cart-item flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-lg shadow-sm" data-id="1" data-price="25.99">
                ...
                <div class="flex-grow text-center sm:text-left">
                    <h2 class="text-lg font-semibold text-gray-800">T-shirt Basique</h2>
                    <p class="text-gray-600">Taille: M, Couleur: Noir</p>
                    <p class="text-xl font-bold text-gray-900 mt-1">€<span class="item-price">25.99</span></p>
                </div>
            ...
            <div class="cart-item flex flex-col sm:flex-row items-center bg-gray-50 p-4 rounded-lg shadow-sm" data-id="2" data-price="49.50">
                <img src="https://placehold.co/100x100/E0E7FF/4F46E5?text=Produit+2" alt="Produit 2" class="w-24 h-24 rounded-lg object-cover mb-4 sm:mb-0 sm:mr-6 flex-shrink-0">
                <div class="flex-grow text-center sm:text-left">
                    <h2 class="text-lg font-semibold text-gray-800">Jean Slim Fit</h2>
                    <p class="text-gray-600">Taille: 32, Couleur: Bleu</p>
                    <p class="text-xl font-bold text-gray-900 mt-1">€<span class="item-price">49.50</span></p>
                </div>
                <div class="flex items-center mt-4 sm:mt-0 sm:ml-6 space-x-2">
                    <button class="quantity-btn decrease-quantity bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-full w-8 h-8 flex items-center justify-center text-lg font-bold transition-colors duration-200">
                        -
        ...
        <!-- Bouton pour ajouter un nouvel article (pour la démo) -->
        <button id="add-item-btn" class="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition-colors duration-200 mb-6 shadow-md">
            Ajouter un article aléatoire
        </button>
