        ...
        <div class="lg:flex lg:space-x-12">
            ...
            <div class="lg:w-1/2 bg-white p-8 rounded-xl shadow-lg">
                ...
                <div class="flex items-center space-x-4 mb-6">
                    ...
                    <a href="{{route('cart.add',$product)}}" class="bg-indigo-600 text-white font-bold py-3 px-8 rounded-full shadow-md hover:bg-indigo-700 transform hover:scale-105 transition-all duration-300 flex-grow">
                        Ajouter au panier
                    </a>
                </div>
